...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "homepage_hero_meta_items" ALTER COLUMN "icon" SET DATA TYPE "public"."enum_homepage_hero_meta_items_icon" USING COALESCE(NULLIF("icon", ''), 'map-pin')::"public"."enum_homepage_hero_meta_items_icon";
  ALTER TABLE "treatments" ALTER COLUMN "icon" SET DEFAULT 'sparkles'::"public"."enum_treatments_icon";
  ALTER TABLE "treatments" ALTER COLUMN "icon" SET DATA TYPE "public"."enum_treatments_icon" USING COALESCE(NULLIF("icon", ''), 'sparkles')::"public"."enum_treatments_icon";
  ALTER TABLE "_treatments_v" ALTER COLUMN "version_icon" SET DEFAULT 'sparkles'::"public"."enum__treatments_v_version_icon";
  ALTER TABLE "_treatments_v" ALTER COLUMN "version_icon" SET DATA TYPE "public"."enum__treatments_v_version_icon" USING COALESCE(NULLIF("version_icon", ''), 'sparkles')::"public"."enum__treatments_v_version_icon";
  ...
  ALTER TABLE "workshops_page_group_healing_items" ALTER COLUMN "icon" SET DATA TYPE "public"."enum_workshops_page_group_healing_items_icon" USING COALESCE(NULLIF("icon", ''), 'users')::"public"."enum_workshops_page_group_healing_items_icon";
  ALTER TABLE "contact_page_contact_cards" ALTER COLUMN "icon" SET DEFAULT 'mail'::"public"."enum_contact_page_contact_cards_icon";
  ALTER TABLE "contact_page_contact_cards" ALTER COLUMN "icon" SET DATA TYPE "public"."enum_contact_page_contact_cards_icon" USING COALESCE(NULLIF("icon", ''), 'mail')::"public"."enum_contact_page_contact_cards_icon";
