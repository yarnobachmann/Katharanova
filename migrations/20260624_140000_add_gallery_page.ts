...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "gallery_page_gallery_items" (
  ...
  CREATE INDEX "gallery_page_gallery_items_order_idx" ON "gallery_page_gallery_items" USING btree ("_order");
  CREATE INDEX "gallery_page_gallery_items_parent_id_idx" ON "gallery_page_gallery_items" USING btree ("_parent_id");
  CREATE INDEX "gallery_page_gallery_items_image_idx" ON "gallery_page_gallery_items" USING btree ("image_id");
