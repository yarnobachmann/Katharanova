...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "gallery_page" ADD COLUMN IF NOT EXISTS "hero_eyebrow" varchar;
  ALTER TABLE "gallery_page" ADD COLUMN IF NOT EXISTS "hero_title" varchar;
  ALTER TABLE "gallery_page" ADD COLUMN IF NOT EXISTS "hero_intro" varchar;
  ALTER TABLE "gallery_page" ADD COLUMN IF NOT EXISTS "hero_image_id" integer;
  DO $$ BEGIN
